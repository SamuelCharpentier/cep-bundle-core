			...
			'isVisibleUI',
			{
				bad: [
					[
						...
						"Validation Error: ui.geometry is required when .ui.type is 'Panel', 'ModalDialog' or 'Modeless' and must be provided as a VisibleGeometry (user manifest configs type) (https://github.com/SamuelCharpentier/cep-bundle-core/blob/main/docs/user-manifest-configs-type.md#VisibleGeometry), true (boolean) received",
					],
					[
						'invalid menu',
						blendConfigs({
						...
						'Validation Error: ui.menu (optional) must be provided as a Menu (user manifest configs type) (https://github.com/SamuelCharpentier/cep-bundle-core/blob/main/docs/user-manifest-configs-type.md#Menu), true (boolean) received',
					],
				],
			},
		],
			...
			'isVisibleResources',
			{
				bad: [
					[
						...
						"Validation Error: dispatchInfo.resources.htmlFileName is required when dispatchInfo.ui.type is 'Panel', 'ModalDialog' or 'Modeless' and must be provided as a relativePath (general type) (https://github.com/SamuelCharpentier/cep-bundle-core/blob/main/docs/general-type.md#relativePath), undefined (undefined) received",
					],
					[
						'an invalid htmlPath',
						blendConfigs({
						...
						"Validation Error: dispatchInfo.resources.htmlFileName is required when dispatchInfo.ui.type is 'Panel', 'ModalDialog' or 'Modeless' and must be provided as a relativePath (general type) (https://github.com/SamuelCharpentier/cep-bundle-core/blob/main/docs/general-type.md#relativePath), 'c:/some/path/to/html.html' (string) received",
					],
				],
			},
		],
