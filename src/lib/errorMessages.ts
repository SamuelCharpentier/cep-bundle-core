...
const bothNeedsToBeProvided: (arg1: string, arg2: string, constructorName: string, val1: any, val2: any) => string = (
	arg1: string,
	arg2: string,
...
const bothWidthAndHeightRequired: (constructorName: string, val1: any, val2: any) => string = (
	constructorName: string,
	val1: any,
	val2: any,
